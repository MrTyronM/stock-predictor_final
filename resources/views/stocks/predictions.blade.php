            ...
            <div class="prediction-cards">
                @forelse($predictions as $prediction)
                    @php
                        ...
                        $change = $latestPrice > 0 ? (($prediction->predicted_price - $latestPrice) / $latestPrice) * 100 : 0;
                    @endphp
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="analysis-card">
                        ...
                        <div class="analysis-desc">AI model confidence</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="analysis-card">
                        ...
                        <div class="analysis-desc">Price fluctuation</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="analysis-card">
                        ...
                        <div class="analysis-desc">Historical performance</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="analysis-card">
                        <div class="analysis-title">Risk Level</div>
                        <div class="analysis-value risk-{{ strtolower($riskLevel ?? 'medium') }}">{{ $riskLevel ?? 'Medium' }}</div>
                        <div class="analysis-desc">Investment risk</div>
                    </div>
                </div>
            </div>
        </div>
...
<style>
    ...
    .recommendation-buy, .risk-low {
        color: #00e676; /* Green */
    }
    
    .recommendation-sell, .risk-high {
        color: #ff5252; /* Red */
    }
